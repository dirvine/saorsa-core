...
|-------------|----------|----------|
| 0.10.x      | 0.21.x   | Event-driven recv, dual-stack QUIC optimizations, PQC-only |
| 0.4.x–0.9.x | 0.14.x   | Unified config, PQC integration |
| 0.3.x       | 0.10.x   | Basic QUIC, NAT traversal |
| Future      | >0.21    | Enhanced relay support |
