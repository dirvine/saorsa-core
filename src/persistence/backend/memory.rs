...
use crate::persistence::{
    Store, Query, Replicate, Migrate, Monitor, Operation, Transaction,
    Result, PersistenceError, NodeId, ReplicationStatus, SyncStats,
    ReplicationConfig, StorageConfig, StorageHealth, StorageMetrics,
    HealthStatus, Migration, ConsistencyLevel,
};
...
pub async fn create_memory_store(config: StorageConfig) -> Result<Arc<dyn Store + Query + Replicate + Migrate + Monitor>> {
