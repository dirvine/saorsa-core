...
pub fn create_mock_dht() -> Arc<crate::dht::core_engine::DhtCoreEngine> {
...
mod integration_tests {
    ...
    async fn test_signaling_validation() {
        ...
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_sdp(valid_sdp).is_ok());
        
        // Test invalid SDP
        let invalid_sdp = "invalid sdp content";
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_sdp(invalid_sdp).is_err());
        
        // Test empty SDP
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_sdp("").is_err());
        
        // Test QUIC endpoint validation
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_quic_endpoint("192.168.1.1:5000").is_ok());
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_quic_endpoint("invalid").is_err());
        assert!(crate::messaging::webrtc::signaling::SignalingHandler::validate_quic_endpoint("").is_err());
    }
}